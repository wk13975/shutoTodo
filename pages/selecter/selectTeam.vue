					...
					<view class="uni-list-cell" hover-class="uni-list-cell-hover" v-for="(item,index) in list" :key="index">
						<view class="uni-media-list" @tap="click(item)">
							<view class="uni-media-list-body">
								...
								<view class="uni-media-list-text-bottom uni-ellipsis">编码:&emsp;{{item.TEAMNUM}} &emsp; &emsp;部门:&emsp;{{item.DEPARTMENT_DESCRIPTION}}</view>
							</view>
						</view>
					</view>
				</view>
	...
	export default {
		...
		methods: {
			...
			request() {
				...
				this.$http.post("/mem/basic/team",data).then(res=>{
