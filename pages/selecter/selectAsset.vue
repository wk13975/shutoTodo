					...
					<view class="uni-list-cell" hover-class="uni-list-cell-hover" v-for="(item,index) in list" :key="index">
						<view class="uni-media-list" @tap="click(item)">
							<view class="uni-media-list-body">
								...
								<view class="uni-media-list-text-bottom uni-ellipsis">设备编码:&emsp;{{item.ASSETNUM}} &emsp; &emsp;位置:&emsp;{{item.LOCATION_DESCRIPTION}}</view>
							</view>
						</view>
					</view>
				</view>
	...
	export default {
		...
		methods: {
			...
			request() {
				...
				this.$http.post("/mem/basic/asset",data).then(res=>{
