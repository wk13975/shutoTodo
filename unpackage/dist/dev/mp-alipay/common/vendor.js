...
/***/ 129:
/*!************************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/mescroll-uni/mescroll-uni.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 130:
/*!*******************************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/mescroll-uni/mescroll-uni-option.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!***********************************************!*\
  !*** G:/uniworkpace/loginDemo/store/index.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    setPerson: function setPerson(state, personid) {
      state.personid = personid;
    },
    setTodo: function setTodo(state, todoList) {
      console.log("待办更新");
      state.todoList = todoList;
    },
    filled: function filled(state, _filled) {
      state.fill = _filled;
    },
  ...
  getters: {
    getHearder: function getHearder(state) {return function () {
        return state.header;
      };},
    getHasLogin: function getHasLogin(state) {return function () {
        return state.hasLogin;
      };},
    getPersonid: function getPersonid(state) {
...
/***/ 17:
/*!**************************************************************!*\
  !*** G:/uniworkpace/loginDemo/utils/luch-request/request.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Request = /*#__PURE__*/function () {function Request() {var _this = this;_classCallCheck(this, Request);_defineProperty(this, "config",
    ...
    /**
       ...
       */ }, { key: "request", value: function () {var _request = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var _this2 = this;var options,_args = arguments;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                options.custom = _objectSpread({}, this.config.custom, {},
    ...
    url) {var _this3 = this;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      return new Promise(function (resolve, reject) {
        uni.request({
          url: _this3.config.baseUrl + url,
          method: "GET",
          success: function success(res) {
            resolve(res);
          },
    ...
    url, data) {var _this4 = this;var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};


      options.header = options.header || this.config.header;
      return new Promise(function (resolve, reject) {
        uni.request({
          url: _this4.config.baseUrl + url,
    ...
    /* filePath,
      	...
      	header,
      	formData,
      	custom */ }, { key: "upload", value: function upload(
    url, _ref)
    ...
    {var _this5 = this;var fileType = _ref.fileType,filePath = _ref.filePath,name = _ref.name,header = _ref.header,formData = _ref.formData,custom = _ref.custom;
      return new Promise(function (resolve, reject) {
        var next = true;
        var handleRe = {};
        var globalHeader = _objectSpread({}, _this5.config.header);

        delete globalHeader['content-type'];
        var pubConfig = {
          baseUrl: _this5.config.baseUrl,
          url: url,
          ...
          formData: formData,
          custom: _objectSpread({}, _this5.config.custom, {},
          custom || {}),

          complete: function complete(response) {
            response.config = handleRe;
            if (response.statusCode === 200) {// 成功
              response = _this5.requestComFun(response);
              resolve(response);
            } else {
              response = _this5.requestComFail(response);
              reject(response);
            }
          } };
        ...
        handleRe = _objectSpread({}, _this5.requestBeforeFun(pubConfig, cancel));
...
/***/ 194:
/*!**************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/uni-icons/icons.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 202:
/*!**************************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/w-picker/city-data/province.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 203:
/*!**********************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/w-picker/city-data/city.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 204:
/*!**********************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/w-picker/city-data/area.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 205:
/*!****************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/w-picker/w-picker.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 27:
/*!****************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/u-charts/u-charts.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 28:
/*!**************************************************!*\
  !*** G:/uniworkpace/loginDemo/common/request.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _index = _interopRequireDefault(__webpack_require__(/*! ../store/index.js */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var url = "https://ser1.itrobot.site/maxrest/rest/";

var requestUtil = {
  doGet: function doGet(api) {
    var hasLogin = _index.default.getters.getHasLogin();
    var header = _index.default.getters.getHearder();
    if (hasLogin) {
      uni.request({
        url: url + api,
        method: "GET",
  ...
  doPost: function doPost(api, data, success) {
    var hasLogin = _index.default.getters.getHasLogin();
    var header = _index.default.getters.getHearder();
    if (hasLogin)
    uni.request({
...
requestUtil;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-alipay/dist/index.js */ 1)["default"]))
...
/***/ 29:
/*!**************************************************!*\
  !*** G:/uniworkpace/loginDemo/common/checker.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 38:
/*!*******************************************!*\
  !*** G:/uniworkpace/loginDemo/service.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 39:
/*!*************************************************!*\
  !*** G:/uniworkpace/loginDemo/common/base64.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!*******************************************!*\
  !*** G:/uniworkpace/loginDemo/pages.json ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 7:
/*!************************************************************!*\
  !*** G:/uniworkpace/loginDemo/pages.json?{"type":"style"} ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/main/main": { "defaultTitle": "首页" }, "pages/login/login": { "defaultTitle": "登录" }, "pages/reg/reg": { "defaultTitle": "注册" }, "pages/pwd/pwd": { "defaultTitle": "找回密码" }, "pages/user/user": { "defaultTitle": "我的" }, "pages/todo/todo": { "defaultTitle": "待办", "pullRefresh": true }, "pages/todo/todoinfo/todoinfo": { "defaultTitle": "待办信息" }, "pages/health/health": { "defaultTitle": "员工健康" }, "pages/defect/defect": { "defaultTitle": "缺陷" }, "pages/defect/defectList": { "defaultTitle": "缺陷" }, "pages/selecter/selecter": { "defaultTitle": "位置选择" }, "pages/selecter/selectAsset": { "defaultTitle": "设备选择" }, "pages/selecter/selectTeam": { "defaultTitle": "班组选择" } }, "globalStyle": { "titleBarColor": "#ff9800", "backgroundColor": "#fbf9fe" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!***********************************************************!*\
  !*** G:/uniworkpace/loginDemo/pages.json?{"type":"stat"} ***!
  \***********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__385653F" };exports.default = _default;

/***/ }),

/***/ 80:
/*!***********************************************!*\
  !*** G:/uniworkpace/loginDemo/common/util.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 89:
/*!***************************************************************************!*\
  !*** G:/uniworkpace/loginDemo/components/mescroll-uni/mescroll-mixins.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
